...
class _Reminder {
  ...
  _Reminder({
    ...
    required this.time, required this.type, required this.priority,
...
class _RemindersScreenState extends State<RemindersScreen>
  ...
  final List<_Reminder> _reminders = [
    _Reminder(
      id: '1', title: 'Deep Focus Block',
      subtitle: 'Project Synthesis — 45 min session',
      time: '2:00 PM', type: ReminderType.focusTime,
      priority: ReminderPriority.high, isAISuggested: true,
    ),
    _Reminder(
      id: '2', title: 'Take a Break',
      subtitle: 'You\'ve been working for 90 minutes',
      time: '3:30 PM', type: ReminderType.breakTime,
      priority: ReminderPriority.medium, isAISuggested: true,
    ),
    _Reminder(
      id: '3', title: 'Design Review Meeting',
      subtitle: 'Team sync — Google Meet',
      time: '4:00 PM', type: ReminderType.meeting,
      priority: ReminderPriority.high,
    ),
    _Reminder(
      id: '4', title: 'Daily Reflection',
      subtitle: 'Journal your wins for today',
      time: '6:00 PM', type: ReminderType.habit,
      priority: ReminderPriority.low, isAISuggested: true,
    ),
    _Reminder(
      id: '5', title: 'Hydration Check',
      subtitle: 'Drink water — stay sharp',
      time: '5:00 PM', type: ReminderType.habit,
      priority: ReminderPriority.low,
    ),
    _Reminder(
      id: '6', title: 'Evening Wind Down',
      subtitle: 'Stop work, prepare for tomorrow',
      time: '7:30 PM', type: ReminderType.custom,
      priority: ReminderPriority.medium, isAISuggested: true,
    ),
  ];
  ...
  List<_Reminder> get _filteredReminders {
    switch (_selectedTab) {
      ...
      case 2: // AI suggested
        return _reminders.where((r) => r.isAISuggested && !r.isDismissed).toList();
      default:
  ...
  Widget _buildTopBar() => Padding(
    ...
    child: Row(
      ...
      children: [
        ...
        Text('Reminders', style: GoogleFonts.spaceGrotesk(
        ...
        child: Row(
          children: [
            ...
            Expanded(child: Column(
              ...
              children: [
                Text('Smart Reminders', style: GoogleFonts.spaceGrotesk(
            ...
            Container(
              ...
              child: Row(mainAxisSize: MainAxisSize.min, children: [
                const Icon(Icons.auto_awesome,
                    color: _violet, size: 11),
                const SizedBox(width: 4),
                Text('ARIA', style: GoogleFonts.spaceGrotesk(
                    color: _violet, fontSize: 10,
                        ...
                        Row(children: [
                          ...
                          if (r.isAISuggested)
                            Container(
                              ...
                              child: Text('AI', style: GoogleFonts.spaceGrotesk(
                                  color: _violet, fontSize: 8,
                            ...
                            child: Row(
                              ...
                              children: [
                                Icon(Icons.access_time_rounded,
                                    ...
                                    size: 11),
                                const SizedBox(width: 4),
                                Text(r.time, style: GoogleFonts.spaceGrotesk(
                    ...
                    GestureDetector(
                      ...
                      child: AnimatedContainer(
                        ...
                        decoration: BoxDecoration(
                          ...
                          boxShadow: r.isEnabled ? [BoxShadow(
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text('Tap + to add one or let ARIA suggest',
              style: GoogleFonts.inter(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(r.title, style: GoogleFonts.spaceGrotesk(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(children: [
                ...
                Text('New Reminder', style: GoogleFonts.spaceGrotesk(
                    color: Colors.white, fontSize: 16,
                    fontWeight: FontWeight.w700)),
              ]),
              const SizedBox(height: 20),
                      ...
                      child: AnimatedContainer(
                        ...
                        child: Row(mainAxisSize: MainAxisSize.min, children: [
                          Icon(t.$2,
                              ...
                              size: 14),
                          const SizedBox(width: 6),
                          Text(t.$3, style: GoogleFonts.spaceGrotesk(
                              color: selected
                                  ? t.$4
                                  : Colors.white.withValues(alpha: 0.4),
                              fontSize: 11,
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      const SizedBox(width: 8),
                      Text('Set Reminder', style: GoogleFonts.spaceGrotesk(
...
class _NebulaPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawCircle(
      Offset(cx * 0.3 + 35 * math.sin(t * math.pi),
    ...
    canvas.drawCircle(
      Offset(cx * 1.65 - 22 * math.cos(t * math.pi),
