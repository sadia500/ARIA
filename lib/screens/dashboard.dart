...
class _ARIADashboardState extends State<ARIADashboard> {
  ...
  List<ARIATask> get _todayTasks => TaskStore.forDate(DateTime.now());
  ...
  // ── STEP 7 — Focus button passes active task ───────────────────────────────
  ...
  // ── STEP 10 — Empty state when no tasks ───────────────────────────────────
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  ...
                  const SizedBox(height: 6),
                  Text(
                    'Tap to add more tasks or start a free focus session',
                    style: GoogleFonts.spaceGrotesk(
                      color: AC.bodyText,
                      fontSize: 12,
                    ),
  ...
  Widget _buildAIInsightCard() {
    final insights = [
      ...
      'You work best when your first task is completed before 10 AM.',
    ];
  ...
  // ── Today's progress with category breakdown ───────────────────────────────
          ...
          child: Column(
            children: [
              Row(
                ...
                children: [
                  Text(
                    '$_todayDone of $_todayTotal completed',
                    style: GoogleFonts.spaceGrotesk(
                      color: Colors.white,
                      fontSize: 14,
                      fontWeight: FontWeight.w600,
              ...
              if (cats.isNotEmpty) ...[
                ...
                Row(
                  children: cats.entries.map((e) {
                    final f = (e.value / _todayTotal * 100).toInt().clamp(
                      1,
                      100,
                    );
                    return Expanded(
