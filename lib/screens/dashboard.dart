...
class _ARIADashboardState extends State<ARIADashboard>
  ...
  int    get _urgent   => _todayTasks.where((t) => t.priority == TaskPriority.high && !t.isDone).length;
  double get _progress => _total == 0 ? 0.0 : _done / _total;

  ARIATask? get _nextTask {
    final hp = _todayTasks.where((t) => !t.isDone && t.priority == TaskPriority.high).toList();
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          Positioned(
            top: -80, right: -60,
            child: _glowOrb(200, _violet, 0.16),
          ),
          // Mint bloom bottom-left
          Positioned(
            bottom: 140, left: -50,
            child: _glowOrb(160, _mint, 0.07),
          ),
          SafeArea(
            bottom: false,
      ...
      Row(children: [
        Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [BoxShadow(color: _violet.withOpacity(0.3), blurRadius: 8)],
          ),
      ...
      Row(children: [
        if (_streak > 1) ...[
          Container(
            ...
            decoration: BoxDecoration(
              color: _glass, borderRadius: BorderRadius.circular(20),
              border: Border.all(color: _glassBorder),
            ),
            child: Row(mainAxisSize: MainAxisSize.min, children: [
              const Text('🔥', style: TextStyle(fontSize: 11)),
              const SizedBox(width: 4),
              Text('$_streak days', style: GoogleFonts.spaceGrotesk(
  ...
  Widget _buildHeroCard() {
    ...
    final name = widget.userName.isEmpty ? 'there' : widget.userName.split(' ').first;
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(color: _violet.withOpacity(0.14), blurRadius: 24, offset: const Offset(0, 8)),
        ],
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Container(
            ...
            child: Text(dateStr.toUpperCase(), style: GoogleFonts.spaceGrotesk(
              color: Colors.white.withOpacity(0.50), fontSize: 9,
              fontWeight: FontWeight.w600, letterSpacing: 1.8,
            )),
          ),
          const SizedBox(height: 10),
          Text(greeting, style: GoogleFonts.spaceGrotesk(
            color: Colors.white.withOpacity(0.60), fontSize: 13,
          )),
          ...
          if (_total > 0) ...[
            Row(children: [
              Text('$_done of $_total tasks done',
  ...
  Widget _buildStatRow() {
    ...
    return Row(
      children: [
        Expanded(child: _statTile(Icons.pending_actions_rounded, '$remaining', 'Remaining', _violet)),
        const SizedBox(width: 10),
        Expanded(child: _statTile(Icons.bolt_rounded, '$_urgent', 'Urgent', _rose)),
        const SizedBox(width: 10),
        Expanded(child: _statTile(Icons.check_circle_outline_rounded, '$_done', 'Done Today', _mint)),
      ],
    );
  }
    ...
    child: Column(
      ...
      children: [
        ...
        Text(label, style: GoogleFonts.spaceGrotesk(
          color: color.withOpacity(0.70), fontSize: 10,
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              ...
              BoxShadow(
                ...
                blurRadius: 30, spreadRadius: -4, offset: const Offset(0, 14),
              ),
            ],
          ),
          child: child,
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        const SizedBox(width: 10),
                        Text('Start Focus Session', style: GoogleFonts.spaceGrotesk(
  ...
  Widget _buildNextTaskSection() => Column(
    ...
    children: [
      ...
      const SizedBox(height: 10),
      _nextTask == null ? _buildAllDoneCard() : _buildTaskCard(_nextTask!, large: true),
    ],
  );
    ...
    child: Container(
      ...
      child: Row(children: [
        ...
        Expanded(child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text('All clear for today! 🎉', style: GoogleFonts.spaceGrotesk(
              color: Colors.white, fontSize: 15, fontWeight: FontWeight.w600,
            )),
            const SizedBox(height: 3),
            Text('Tap to add more tasks', style: GoogleFonts.spaceGrotesk(
  ...
  Widget _buildTaskCard(ARIATask task, {bool large = false}) {
    final priorityColor = task.priority == TaskPriority.high
        ? _rose : task.priority == TaskPriority.medium ? _amber : _mint;
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: large ? [
            BoxShadow(color: priorityColor.withOpacity(0.10),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              borderRadius: BorderRadius.circular(6),
                              border: Border.all(color: priorityColor.withOpacity(0.28)),
                            ),
                            child: Row(mainAxisSize: MainAxisSize.min, children: [
                              ...
                              const SizedBox(width: 4),
                              Text(task.priority.label, style: GoogleFonts.spaceGrotesk(
                          ...
                          Container(
                            padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 3),
                            decoration: BoxDecoration(
                              color: _glass, borderRadius: BorderRadius.circular(6),
                              border: Border.all(color: _glassBorder),
                            ),
                            child: Text(task.category.label, style: GoogleFonts.spaceGrotesk(
                              color: Colors.white.withOpacity(0.60), fontSize: 10,
                      ...
                      Text(task.title, style: GoogleFonts.spaceGrotesk(
                        color: Colors.white,
                      ...
                      Row(children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color: _glass, borderRadius: BorderRadius.circular(5),
                          ),
                          child: Row(children: [
              ...
              children: [
                Padding(
                  ...
                  child: Row(children: [
                    ...
                    Expanded(
                      child: Text(task.title, style: GoogleFonts.spaceGrotesk(
                        color: Colors.white.withOpacity(0.85), fontSize: 13,
                        fontWeight: FontWeight.w600,
                      ), overflow: TextOverflow.ellipsis),
                    ),
                    const SizedBox(width: 8),
                    Text(task.startTime, style: GoogleFonts.spaceGrotesk(
  ...
  Widget _buildAICard() => GestureDetector(
    onTap: () => Navigator.push(context, MaterialPageRoute(
      builder: (_) => AriaAIScreen(initialMessage: _insight),
    )),
    child: Container(
      width: double.infinity,
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(color: _violetGlow.withOpacity(0.18),
          ...
          Row(children: [
            Container(
              ...
              decoration: BoxDecoration(
                ...
                gradient: RadialGradient(colors: [
                  _violet.withOpacity(0.50), _violetDeep.withOpacity(0.30),
                ]),
                border: Border.all(color: _violet.withOpacity(0.40)),
                boxShadow: [BoxShadow(color: _violet.withOpacity(0.22), blurRadius: 8)],
              ),
            ...
            Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Text('ARIA INSIGHT', style: GoogleFonts.spaceGrotesk(
                color: _violet, fontSize: 9,
                fontWeight: FontWeight.w700, letterSpacing: 2,
              )),
              Text('Personalised for you', style: GoogleFonts.spaceGrotesk(
            ...
            Container(
              ...
              child: Text('Chat with ARIA →', style: GoogleFonts.spaceGrotesk(
                color: _violet, fontSize: 10, fontWeight: FontWeight.w600,
              )),
            ),
          ]),
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                const SizedBox(width: 12),
                Expanded(
                  child: Text(_insight, style: GoogleFonts.spaceGrotesk(
...
class _RingWidget extends StatefulWidget {
  ...
  const _RingWidget({required this.progress, required this.done, required this.total});
...
class _RingPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawCircle(
      ...
      3.5, Paint()..color = const Color(0xFF3DD68C),
    );
  }
