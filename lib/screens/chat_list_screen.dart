...
// ignore_for_file: use_build_context_synchronously, curly_braces_in_flow_control_structures, unused_element, unused_import, deprecated_member_use
    ...
    return Scaffold(
      ...
      floatingActionButton: GestureDetector(
        onTap: () async {
          ...
          Navigator.push(
            context,
            MaterialPageRoute(builder: (_) => AriaAIScreen(chatId: chatId)),
          );
        },
        child: Container(
          width: 56,
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          prefixIcon: Icon(
            ...
            color: _violet.withOpacity(0.60),
            size: 18,
          ),
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (ctx, snap) {
        if (snap.connectionState == ConnectionState.waiting) {
          return const Center(
            child: CircularProgressIndicator(color: _violet, strokeWidth: 1.5),
          );
        }
  ...
  Widget _buildEmptyState() => Center(
    child: Column(
      ...
      children: [
        ...
        Text(
          'Tap + to start chatting with ARIA',
          style: GoogleFonts.spaceGrotesk(
            color: Colors.white.withOpacity(0.30),
            fontSize: 13,
          ),
      ...
      Paint()
        ..shader =
            RadialGradient(
              ...
              Rect.fromCircle(
                center: Offset(size.width * 0.85, size.height * 0.70),
